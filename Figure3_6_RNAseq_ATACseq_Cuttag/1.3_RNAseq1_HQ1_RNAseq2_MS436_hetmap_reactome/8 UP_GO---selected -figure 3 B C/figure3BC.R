...
GO = read.table("RNA1_RNA2_UP_GO_selected_21.txt",header=TRUE,sep="\t",quote = "")  #读取第1部分enrichGO分析输出的文件eG。
...
labs(color="-log10(p.adjust)",size="Count", 
     shape="Group",x="Group",y="Group",title="GO:BP") +
  theme_bw()+
  theme(panel.grid=element_blank())
...
ggsave("1121——RNA1_2_GO_UP_combine_p.adjust——1.31bubble_final2.pdf", width =7, height = 5)
