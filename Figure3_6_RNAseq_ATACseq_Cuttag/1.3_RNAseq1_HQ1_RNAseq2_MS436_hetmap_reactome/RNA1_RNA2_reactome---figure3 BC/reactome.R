...
GO = read.table("RNA1_RNA2_UP_Reactome_combine.txt",header=TRUE,sep="\t",quote = "")  #读取第1部分enrichGO分析输出的文件eG。
...
p
?ggsave
ggsave("RNA1_RNA2_UP_Reactome_combine_pvalue.pdf", width = 6, height = 5)
...
ggsave("RNA1_RNA2_UP_Reactome_combine_padjust.pdf", width = 6, height = 5)
