...
ggsave("UID_GO_combine_pvalue——1104_bubble——final.pdf", width =8 , height = 5)
...
# p2_npg
log10(0.05)
ggsave("UID_GO_combine_p.adjust——1104_bubble_final.pdf", width =8 , height = 5)
